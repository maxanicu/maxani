...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 7 </h3>
		<div class="frame-contain"><iframe SRC="https://www.mp4upload.com/embed-dpvxeanf5iws.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=100% HEIGHT=400 allowfullscreen></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="persona 5 the animation episode 6.php" class="previous round" title="Ep. 6">&#8249;</a>
			<div class="next_inline" >
				<a href="persona 5 the animation-main.php" class="previous margin_theme" title="home">Home</a>
				<a href="persona 5 the animation episode 8.php" class="next round margin_theme" title="Ep. 8" >&#8250;</a> 
			</div>
		</div>
</div>
<?php
