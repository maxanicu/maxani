...
<meta name="msapplication-navbutton-color" content="#46b4e4">
...
<body>
  ...
  <header>
    <nav>
      <ul>
        <li><a href="index.php"><span class="blu_span">A</span><span class="title">W</span></a></li>
  ...
  <div id="ne">
    <div class="overflow" id="scroll">
      <form  action="catalog.php"  method="get" id="formSearch">
        <label></label>
      <input id="myInput"  autofocus="type" name="s" autocomplete="off"   />
    </form>
