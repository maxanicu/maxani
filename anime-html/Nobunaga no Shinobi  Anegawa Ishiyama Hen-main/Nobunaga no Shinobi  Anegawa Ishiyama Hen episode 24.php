...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 24</h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTEwMTE2&amp;title=Nobunaga+no+Shinobi%3A+Anegawa+Ishiyama-hen+episode+24&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px;" class="margin_theme margin">
		<a href="Nobunaga no Shinobi  Anegawa Ishiyama Hen episode 23.php" class="previous round" title="Ep. 23">&#8249;</a>
		<a href="Nobunaga no Shinobi  Anegawa Ishiyama Hen-main.php" class="previous " title="Home">Home</a>
		<a href="Nobunaga no Shinobi  Anegawa Ishiyama Hen episode 25.php" class="next round margin_theme" title="Ep. 25">&#8250;</a>
	</div>
</div>
<?php
