...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 5  </h3>
		<div class="frame-contain"><iframe SRC="https://www.mp4upload.com/embed-opo8smlljspk.html" FRAMEBORDER=0 MARGINWIDTH=0 MARGINHEIGHT=0 SCROLLING=NO WIDTH=100% HEIGHT=500 allowfullscreen></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="inazuma eleven ares no tenbin  episode 4.php" class="previous round" title="Ep. 4">&#8249;</a>
			<div class="next_inline" >
				<a href="inazuma-eleven-ares-no-tenbin-main.php" class="previous margin_theme" title="home">Home</a>
				<a href="inazuma eleven ares no tenbin  episode 6.php" class="next round margin_theme" title="Ep. 6">&#8250;</a>
			</div>
		</div>
</div>
<?php
