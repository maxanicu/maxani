...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 5 </h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTEwOTAz&amp;title=Sora+to+Umi+no+Aida+Episode+5" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px;" class="margin_theme margin">
		<a href="Sora to Umi no Aida episode 4.php" class="previous round" title="Ep. 4">&#8249;</a>
		<a href="Sora to Umi no Aida-main.php" class="previous " title="Home">Home</a>
		
		<a href="Sora to Umi no Aida episode 6.php" class="next round margin_theme" title="Ep. 6">&#8250;</a>
