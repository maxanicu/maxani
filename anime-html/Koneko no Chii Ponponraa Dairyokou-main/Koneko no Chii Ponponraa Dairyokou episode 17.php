...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 17</h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTA3MjM0&amp;title=Koneko+no+Chii%3A+Ponponraa+Dairyokou+episode+17&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px;" class="margin_theme margin">
		<a href="Koneko no Chii Ponponraa Dairyokou episode 16.php" class="previous round" title="Ep. 16">&#8249;</a>
		<a href="Koneko no Chii Ponponraa Dairyokou-main.php" class="previous " title="Home">Home</a>
		
		<a href="Koneko no Chii Ponponraa Dairyokou episode 18.php" class="next round margin_theme" title="Ep. 18">&#8250;</a>
	</div>
</div>
<?php
