...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode  13 </h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTEyMDE0&amp;title=Double+Decker%21+Doug+%26+Kirill+Episode+13" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px;" class="margin_theme margin">
		<a href="Double Decker! Doug & Kirill episode 12.php" class="previous round" title="Ep. 12">&#8249;</a>
		<a href="Double Decker! Doug & Kirill-main.php" class="previous " title="Home">Home</a>
		<!--
		<a href="Double Decker! Doug & Kirill episode 14.php" class="next round margin_theme" title="Ep. 14">&#8250;</a>
	-->
	</div>
</div>
<?php
