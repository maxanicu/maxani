...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 3 </h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTEwNjAy&amp;title=Kirakira+Happy%E2%98%85Hirake%21+Cocotama+episode+3&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="Kirakira Happy Hirake! Cocotama episode 2.php" class="previous round" title="Ep. 2">&#8249;</a>
			<div class="next_inline" >
				<a href="Kirakira Happy Hirake! Cocotama-main.php" class="previous margin_theme" title="home">Home</a>
				<!--
				<a href="Kirakira Happy Hirake! Cocotama episode 4.php" class="next round margin_theme" title="Ep. 4">&#8250;</a>
			-->
			</div>
	</div>
</div>
