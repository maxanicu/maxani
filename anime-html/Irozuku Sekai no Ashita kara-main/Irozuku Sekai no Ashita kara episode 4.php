...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 4 </h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTEwODA3&amp;title=Irozuku+Sekai+no+Ashita+kara+Episode+4" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="Irozuku Sekai no Ashita kara episode 3.php" class="previous round" title="Ep. 3">&#8249;</a>
			<div class="next_inline" >
				<a href="Irozuku Sekai no Ashita kara-main.php" class="previous margin_theme" title="home">Home</a>
				
				<a href="Irozuku Sekai no Ashita kara episode 5.php" class="next round margin_theme" title="Ep. 5">&#8250;</a>
