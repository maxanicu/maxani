...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 7 </h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTExMTc3&amp;title=JoJo+no+Kimyou+na+Bouken%3A+Ougon+no+Kaze+episode+7&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="JoJo no Kimyou na Bouken Ougon no Kaze episode 6.php" class="previous round" title="Ep. 6">&#8249;</a>
			<div class="next_inline" >
				...
				<a href="JoJo no Kimyou na Bouken Ougon no Kaze episode 8.php" class="next round margin_theme" title="Ep. 8">&#8250;</a>
			</div>
		</div>
</div>
<?php
