...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 8</h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=MTA5NTIw&amp;title=Isekai+Maou+to+Shoukan+Shoujo+no+Dorei+Majutsu+episode+8&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px; " class="margin_theme margin">
			<a href="Isekai Maou to Shoukan Shoujo no Dorei Majutsu episode 7.php" class="previous round" title="Ep. 7">&#8249;</a>
			<div class="next_inline" >
				...
				<a href="Isekai Maou to Shoukan Shoujo no Dorei Majutsu episode 9.php" class="next round margin_theme" title="Ep. 9" >&#8250;</a>
			</div>
		</div>
</div>
<?php
