...
<div style="margin-bottom: 50px;">
	<div class="container_div" >  <br>
		<br>
		<h3>Episode 64</h3>
		<div class="frame-contain"><iframe src="https://vidstreaming.io/streaming.php?id=OTU1&amp;title=Hunter+X+Hunter+2011+episode+64&amp;typesub=SUB" allowfullscreen="true" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" width="100%" height="100%"></iframe></div>
	</div>
	<div style=" margin-top: 30px;" class="margin_theme margin">
		<a href="Hunter X Hunter 2011 episode 63.php" class="previous round" title="Ep. 63">&#8249;</a>
		<a href="Hunter X Hunter 2011-main.php" class="previous " title="Home">Home</a>
		<a href="Hunter X Hunter 2011 episode 65.php" class="next round margin_theme" title="Ep. 65">&#8250;</a>
	</div>
</div>
<?php
